...
exports.seed = async function(knex) {
  ...
  await knex('steps_ingredients').insert([
    { step_id: 2, ingredient_id: 1, quantity: 1 }, // Olive oil in Add 1 tbsp olive oil
    { step_id: 3, ingredient_id: 2, quantity: 500 }, // Minced beef in Add minced beef and cook until browned
    { step_id: 5, ingredient_id: 3, quantity: 1 }, // Chicken in Season the chicken
    { step_id: 5, ingredient_id: 4, quantity: 1 }, // Salt in Season the chicken
    { step_id: 5, ingredient_id: 5, quantity: 1 } // Pepper in Season the chicken
  ]);
};
